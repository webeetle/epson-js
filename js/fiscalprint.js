...
//
export function encodeBase64Binary(s) {
    var r = '';
    var l = s.length;
...
export function fireFiscalReceiveEvent(epos, xhr)
{
    if (epos.onreceive)
    {
...
export function fireFiscalErrorEvent(epos, xhr)
{
    // fire onerror event
